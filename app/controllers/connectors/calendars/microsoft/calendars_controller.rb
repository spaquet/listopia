    ...
    module Microsoft
      ...
      class CalendarsController < Connectors::BaseController
        ...
        def select
          ...
          redirect_to connectors_calendars_microsoft_events_path, notice: "Calendar selected"
        end
        ...
        def fetch_user_calendars
          service = ::Connectors::Microsoft::CalendarFetchService.new(
