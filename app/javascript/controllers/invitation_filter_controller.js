// app/javascript/controllers/invitation_filter_controller.js
...
export default class extends Controller {
  ...
  connect() {
    console.log("[InvitationFilter] Controller connected v1.0")
  ...
  handleSearchInput(event) {
    console.log("[InvitationFilter] Search input triggered, debouncing...")
    ...
    this.debounceTimeout = setTimeout(() => {
      console.log("[InvitationFilter] Debounce complete, submitting search")
      this.submitForm()
  ...
  filterChange(event) {
    console.log("[InvitationFilter] Filter changed:", event.currentTarget.dataset.filterType)
  ...
  submitForm() {
    console.log("[InvitationFilter] Submitting form")
    ...
    console.log("[InvitationFilter] Fetching from:", url)
  ...
  clearFilters(event) {
    ...
    console.log("[InvitationFilter] Clear filters clicked")
    ...
    console.log("[InvitationFilter] Navigating to base invitations path")
  ...
  showLoadingIndicator() {
    console.log("[InvitationFilter] Loading...")
  }
  ...
  restoreSearchFocus(event) {
    ...
    if (this.hasSearchInputTarget && this.searchInputTarget.value.length > 0) {
      ...
      setTimeout(() => {
        ...
        console.log("[InvitationFilter] Focus restored to search input")
      }, 10)
    }
  }
}
